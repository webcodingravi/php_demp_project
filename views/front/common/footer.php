     ...
     <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div class="grid md:grid-cols-4 gap-8 mb-12">
             ...
             <div class="col-span-2">
                 <div class="flex items-center space-x-2 mb-4">
                     ...
                     <span class="text-2xl font-bold">Business<span class="text-primary">Corp</span></span>
                 </div>
                 <p class="text-gray-400 mb-6 max-w-md">We provide innovative business solutions to help companies
                     grow and succeed in the digital age. Your success is our priority.</p>
                 <div class="flex space-x-4">
                     <a href="#"
                         class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-primary transition">
         ...
         <div class="border-t border-gray-800 pt-8">
             <div class="flex flex-col md:flex-row justify-between items-center">
                 <p class="text-gray-400 text-sm">&copy; 2026 BusinessCorp. All rights reserved.</p>
